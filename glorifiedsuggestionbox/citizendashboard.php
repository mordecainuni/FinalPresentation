...
//
  ?><div id="id01" class="w3-modal">
    <div class="w3-modal-content">
      ...
      <?
        echo'<form class="w3-container w3-light-grey">
  <label>TYPE HERE</label>
  <input class="w3-input w3-border-0" type="text" name="PostContent">
  ...
  <input class="w3-input w3-border-0" type="date" name="PostDate">
</form>
      </div>
    </div>
  </div>
