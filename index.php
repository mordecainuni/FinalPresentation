...
<div class="w3-top">
  <ul class="w3-navbar w3-red w3-card-2 w3-left-align w3-large">
    ...
    <li class="w3-hide-small"><a href="#" class="w3-padding-large w3-hover-white">Login</a></li>
  </ul>
...
<header class="w3-container w3-red w3-center w3-padding-128">
  <h1 class="w3-margin w3-jumbo">Your Sentiments. Heard</h1>
  <p class="w3-xlarge">A new way of letting your voice be heard, and your issues addressed.</p>
  <button onclick="document.getElementById('id01').style.display='block'" class="w3-btn w3-large">
      Get Started
    </button>
  ...
  <div id="id01" class="w3-modal">
    <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
      ...
      <form class="w3-container" action="form.asp">
        ...
        <a href="#"><button class="w3-btn-block w3-green w3-section w3-padding" type="submit">
          Login
        </button>
        <a/>
            <p>
